  ...
  const fetchDefaultPriceList = async () => {
    try {
      ...
      if (defaultPriceList) {
        ...
        const detailResponse = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL || 'https://expressjs-postgres-production-6aba.up.railway.app'}/api/price-lists/${defaultPriceList.price_list_id}`, {
          headers: {
