  ...
  return (
    <html lang="tr" className="scroll-smooth">
      <head>
        ...
        <link rel="preconnect" href={process.env.NEXT_PUBLIC_API_BASE_URL || "https://expressjs-postgres-production-6aba.up.railway.app"} />
        <link rel="dns-prefetch" href={process.env.NEXT_PUBLIC_API_BASE_URL || "https://expressjs-postgres-production-6aba.up.railway.app"} />
